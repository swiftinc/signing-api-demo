...
Also, make sure you have followed the guide to "Create an app" and for "Request web client certificate" on https://developer.swift.com
...
3. **Set environment variables**  
   Set the required environment varibles in the file `backend/.env`. See: [Environment Variables](#environment-variables)
...
SWIFT_API_HOST=api.swift.com
SWIFT_PRIVATE_KEY="/path/to/privateKey.pem"
SWIFT_CERTIFICATE="/path/to/certificate.pem"
